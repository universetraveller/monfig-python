...
from monfig import Optional, default, Allow
from monfig import Final, Disabled

REQUIRED = Required
MANDATORY = Mandatory
OPT_PRESENT = Optional
OPT_NOT_PRESENT = Optional
OPT_PRESENT_1 = default
OPT_NOT_PRESENT_1 = default
OPT_PRESENT_2 = Allow
OPT_NOT_PRESENT_2 = Allow
FINAL: Final = 10
